...
const ViewActivity = () => {
    const activity1 = new ExerciseTaskModel(1, 'Walk among dead', "walking with friends", ActivityTypeEnum.Walk, '15:00:00', '2023-03-15');
    ...
    const activity4 = new ExerciseTaskModel(4, 'Hike among dead', "Hiking is my hobby!", ActivityTypeEnum.Hike, '15 min', '2023-03-15');
    const activity5 = new ExerciseTaskModel(5, 'Swim among dead', "Swiming with friends", ActivityTypeEnum.Swim, '30 seconds', '2023-03-15');
